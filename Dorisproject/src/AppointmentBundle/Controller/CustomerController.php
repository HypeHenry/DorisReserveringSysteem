...
use AppointmentBundle\Entity\Customer;
...
class CustomerController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppointmentBundle\Form\CustomerType', $customer);
        ...
        return $this->render('@Appointment/customer/new.html.twig', array(
            'customer' => $customer,
    ...
    {
        $deleteForm = $this->createDeleteForm($customer);
        $editForm = $this->createForm('AppointmentBundle\Form\CustomerType', $customer);
